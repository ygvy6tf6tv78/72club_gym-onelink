  ...
  return (
    ...
    >
      <span
        ...
        style={{ background: isActive ? '#111111' : 'rgba(255,255,255,0.16)' }}
      >
...
function ServiceCard({
  ...
  return (
    <motion.article
      ...
      className="relative overflow-hidden rounded-[20px] border bg-white p-3.5 shadow-[0_8px_20px_rgba(185,28,28,0.06),inset_0_1px_0_rgba(255,255,255,0.95)]"
      style={{ borderColor: '#2A2A2A' }}
    >
      <div className="flex items-start gap-3">
        <div className="relative flex h-14 w-14 shrink-0 items-center justify-center overflow-hidden rounded-2xl bg-[#111111] ring-1 ring-[#2A2A2A]">
        ...
        <div className="min-w-0 flex-1 pr-12">
          <div className="flex items-start justify-between gap-2">
            ...
            <span className="shrink-0 rounded-full bg-[#111111] px-2 py-1 text-[10px] font-black uppercase tracking-[0.1em] text-[#B91C1C]">
      ...
      <div className="absolute bottom-3 right-3 flex h-11 w-11 items-center justify-center rounded-2xl bg-white shadow-[0_8px_18px_rgba(15,23,42,0.10)] ring-1 ring-[#2A2A2A]">
        <Link
  ...
  return (
    <main className="min-h-screen bg-white px-3 pb-10 pt-[max(0.75rem,env(safe-area-inset-top))]">
      <div className="mx-auto w-full max-w-md">
        <header
          className="mb-4 overflow-hidden rounded-[28px] border border-white/20 p-3.5 text-white shadow-[0_14px_30px_rgba(185,28,28,0.20)]"
        ...
        >
          ...
          <nav className="mt-3 grid grid-cols-3 gap-2 rounded-2xl border border-white/15 bg-black/10 p-1.5 backdrop-blur-md" aria-label="Services navigation">
            ...
            <Link href="/book-consultation" className="flex h-9 items-center justify-center rounded-xl bg-white text-[11px] font-black text-[#B91C1C]">Book Visit</Link>
          </nav>
        ...
        <div className="mb-3 flex items-center justify-between px-1">
          ...
          <span className="shrink-0 rounded-full bg-[#111111] px-2.5 py-1 text-xs font-black text-[#B91C1C]">
