      ...
      <div className="mx-auto w-full max-w-md">
        ...
        >
          ...
          <nav className="mt-3 grid grid-cols-3 gap-2 rounded-2xl border border-white/15 bg-black/10 p-1.5 backdrop-blur-md" aria-label="Portfolio navigation">
            ...
            <Link href="/book-consultation" className="flex h-9 items-center justify-center rounded-xl bg-white text-[11px] font-black text-[#B91C1C]">Consult</Link>
          </nav>
            ...
            {categories.map((category) => {
              ...
              <button
                ...
                style={{
                  ...
                  color: active === category ? '#B91C1C' : '#FFFFFF',
        ...
        <div className="grid gap-5">
          {visibleProjects.map((project, index) => (
            <motion.article
              ...
              className="overflow-hidden rounded-[30px] border border-[#EADBC9] bg-white p-2 shadow-[0_20px_44px_rgba(185,28,28,0.12)]"
            >
              ...
              <div className="px-3 pb-3 pt-4">
                ...
                <p className="mt-2 flex items-center gap-1.5 text-[11px] font-bold uppercase tracking-[0.08em] text-[#E1261C]"><MapPin className="h-3.5 w-3.5" /> {project.location}</p>
                ...
                <div className="mt-4 grid grid-cols-2 gap-2.5">
                  <a
                    ...
                    style={{
                      ...
                      boxShadow: '0 8px 20px rgba(185,28,28,0.34), 0 4px 8px rgba(0,0,0,0.10), inset 0 1px 0 rgba(255,255,255,0.20)',
