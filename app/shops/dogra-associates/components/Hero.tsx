...
import { MapPin, Clock, Store, Hand, Award, Calendar, FileText, ArrowLeft, Share2 } from 'lucide-react'
...
export default function Hero() {
  ...
  const shareCard = async () => {
    ...
    const shareData = {
      title: 'Club72 Gym',
      text: "Club72 Gym — India's biggest gym in Mohali.",
    ...
    try {
      ...
      // Closing the native share sheet should leave the card unchanged.
    }
  }
  ...
  const doctorCredentials = ['Strength', 'Performance', 'Wellness']
  ...
  const computeOpenStatus = useCallback(() => {
    ...
    const startDay = DAY_ABBR_TO_INDEX[startDayStr]
    const endDay = DAY_ABBR_TO_INDEX[endDayStr]
    ...
    >
      <Card3D
        ...
        faceFront={
          ...
          style={{
            background:
              'linear-gradient(180deg, rgba(255,255,255,0.98) 0%, #ffffff 54%, #FFFFFF 100%)',
          ...
          >
            ...
            {currentFace === 'front' && (
              <motion.button
                ...
                style={{
                  ...
                  boxShadow: '0 8px 18px rgba(185,28,28, 0.18), 0 2px 6px rgba(15, 23, 42, 0.08)',
                }}
            ...
            >
              ...
              <motion.a
                ...
                className="flex h-11 w-11 items-center justify-center rounded-full border border-[#F3CAD9] bg-white shadow-[0_10px_22px_rgba(225,48,108,0.22),0_4px_8px_rgba(15,23,42,0.14)]"
              ...
              <motion.button
                ...
                className="flex h-11 w-11 items-center justify-center rounded-full border border-[#E7E7E7] bg-white text-[#111111] shadow-[0_10px_22px_rgba(15,23,42,0.16),0_4px_8px_rgba(15,23,42,0.10)]"
                aria-label="Share Club72 card"
              >
            ...
            <div
              ...
              style={{
                background:
                  'linear-gradient(180deg, rgba(255,255,255,0.90) 0%, rgba(255,255,255,0.99) 36%, #FFFFFF 100%)',
              }}
            >
              ...
              >
                <div
                  className="w-32 h-32 rounded-full flex items-center justify-center overflow-hidden bg-[#050505] p-1"
                  style={{
                    border: '2px solid rgba(225,38,28,0.72)',
                    boxShadow:
                      '0 16px 32px rgba(185,28,28,0.22), 0 5px 12px rgba(15,23,42,0.16), inset 0 0 0 1px rgba(225,38,28,0.18)',
                  }}
                >
                  <Image
              ...
              >
                ...
                <p className="font-black text-[15px] mb-0.5 uppercase tracking-[0.08em]" style={{ color: '#E1261C' }}>
                  {shopConfig.tagline}
                </p>
                        ...
                        return (
                          <span
                            ...
                            style={{
                              ...
                              color: '#B91C1C',
                              border: '1px solid rgba(225,38,28,0.24)',
                              boxShadow: '0 2px 7px rgba(225,38,28,0.08)',
                            }}
                          >
                            <Icon className="w-3.5 h-3.5 flex-shrink-0" style={{ color: '#E1261C' }} strokeWidth={2.2} />
        ...
        faceInfo={
          <div
            ...
            style={{
              ...
              boxSizing: 'border-box',
              background: 'linear-gradient(135deg, #E1261C 0%, #D12325 48%, #AD171A 100%)',
              borderColor: 'rgba(225,38,28, 0.5)',
              boxShadow: '0 18px 40px rgba(185,28,28,0.24), 0 0 0 1px rgba(225,38,28,0.15)',
            }}
            onClick={(e) => {
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background:
                      'linear-gradient(135deg, rgba(255,255,255,0.96) 0%, rgba(255,245,244,0.96) 100%)',
                    borderColor: 'rgba(225,38,28, 0.4)',
                  }}
                >
                  <div
                    className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 shadow-[0_8px_18px_rgba(185,28,28,0.22)]"
                    style={{ background: 'linear-gradient(135deg, #B91C1C 0%, #E1261C 100%)' }}
                  >
                ...
                >
                  ...
                  <div className="min-w-0 flex-1 text-left">
                    <p className="text-sm font-bold leading-snug text-slate-900">Facilities</p>
                    <p className="text-xs sm:text-sm leading-relaxed text-slate-700">
                ...
                <div
                  ...
                  style={{
                    ...
                    borderColor: 'rgba(225,38,28, 0.35)',
                  }}
                >
                  <iframe
        ...
        faceDoctor={
          <div
            ...
            style={{
              minHeight: 'min(580px, 85dvh)',
              boxSizing: 'border-box',
              backgroundImage: 'radial-gradient(circle at 100% 0%, #fff1f2 0%, transparent 40%), radial-gradient(circle at 0% 100%, #f5f5f5 0%, transparent 40%)',
          ...
          >
            <div className="relative h-[220px] shrink-0 overflow-hidden rounded-t-[24px]">
              <Image
                src="/club72/coaching.jpg"
                alt="Club72 fitness coaches"
                fill
              ...
              <button
                ...
                className="absolute left-4 top-4 z-30 flex h-10 items-center justify-center gap-1.5 rounded-full bg-white/95 px-4 text-sm font-black text-[#B91C1C] shadow-[0_10px_24px_rgba(185,28,28,0.16)] ring-1 ring-[#EAEAEA] backdrop-blur-md transition-transform active:scale-95 touch-manipulation"
                style={{ WebkitTapHighlightColor: 'transparent' }}
            ...
            <div className="relative z-10 flex flex-1 flex-col justify-between px-5 pb-6 pt-1">
              <div className="flex flex-col gap-2 -mt-10">
                <div className="text-center shrink-0 relative z-10 mb-1">
                  <p className="text-[11px] font-black uppercase tracking-[0.2em] text-[#CFCFCF] mb-0.5">
                    Expert Coaching
                  </p>
                ...
                <div className="flex flex-wrap gap-1.5 justify-center shrink-0">
                  {doctorCredentials.map((item) => (
                    <span
                      key={item}
                      className="rounded-full border border-[#CFCFCF]/20 bg-[#f0fdf4] px-3 py-1.5 text-[11px] font-bold tracking-wide text-[#CFCFCF] shadow-sm"
                    >
                      {item}
                    </span>
                  ))}
                ...
                <div className="shrink-0 rounded-[18px] border border-slate-100 bg-white p-3.5 shadow-[0_4px_16px_rgba(0,0,0,0.03)] text-center">
                  <p className="text-[13px] font-bold leading-5 text-slate-800">
                    Coaching built around your goal
                  </p>
                  <p className="mt-1.5 text-[12px] font-medium leading-5 text-slate-500">
                    Structured training, better technique and the accountability to keep progressing.
                  </p>
                </div>
                ...
                <div className="shrink-0 grid grid-cols-2 gap-2">
                  <div className="rounded-[16px] border border-slate-100 bg-white px-2 py-2.5 shadow-[0_4px_12px_rgba(0,0,0,0.02)] text-center flex flex-col justify-center">
                    <p className="text-[10px] font-black uppercase tracking-[0.16em] text-[#CFCFCF]">Owner</p>
                    <p className="mt-1 text-[11px] font-bold leading-snug text-slate-800">Club72 Gym</p>
                  </div>
                  <div className="rounded-[16px] border border-slate-100 bg-white px-2 py-2.5 shadow-[0_4px_12px_rgba(0,0,0,0.02)] text-center flex flex-col justify-center">
                    <p className="text-[10px] font-black uppercase tracking-[0.16em] text-[#CFCFCF]">Focus</p>
                    <p className="mt-1 text-[11px] font-bold leading-snug text-slate-800">Real, measurable progress</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-4 mb-2 flex flex-col gap-2.5">
                <Link
                  ...
                  className="flex shrink-0 h-[52px] w-full items-center justify-center gap-2 rounded-[16px] text-[15px] font-black text-white shadow-[0_12px_24px_rgba(185,28,28,0.22)] transition-transform active:scale-[0.98] cursor-pointer touch-manipulation"
                  style={{ background: 'linear-gradient(135deg, #B91C1C 0%, #E1261C 100%)' }}
                >
