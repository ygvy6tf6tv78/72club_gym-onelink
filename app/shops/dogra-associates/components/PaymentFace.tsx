...
export default function PaymentFace({
  ...
  if (!upiId) {
    const message = encodeURIComponent('Hello Club72 Gym, please share the payment details for my membership.')
    return (
      <div
      ...
      >
        <div className="relative z-10 flex min-h-[580px] flex-col items-center justify-center px-7 py-8 text-center">
          ...
          <p className="mt-3 max-w-xs text-sm font-medium leading-6 text-white/75">
            Payment details are shared against your confirmed membership or service invoice.
          </p>
          <a
          ...
          >
            <motion.button
              ...
              style={{
                WebkitTapHighlightColor: 'transparent',
                background:
                  'linear-gradient(135deg, #0F766E 0%, #0F766E 58%, #111315 100%)',
                boxShadow:
