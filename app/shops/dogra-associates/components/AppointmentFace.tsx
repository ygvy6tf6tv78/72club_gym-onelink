...
const inputBase =
  'w-full min-w-0 bg-white rounded-xl px-4 py-3.5 text-[16px] text-slate-900 placeholder:text-slate-400 focus:outline-none transition-all duration-200 border-2 border-slate-200/90 focus:border-[#E1261C] focus:shadow-[0_0_0_3px_rgba(225,38,28,0.2)] shadow-[4px_4px_12px_rgba(15,42,68,0.08),-2px_-2px_8px_rgba(255,255,255,0.8)]'
...
Please confirm my trial slot.`
  ...
  return (
    <div
      ...
      style={{
        background: 'linear-gradient(160deg, #2A2A2A 0%, #111111 42%, #E1261C 100%)',
        padding: 22,
        minHeight: '580px',
        boxSizing: 'border-box',
        boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.78), 0 4px 20px rgba(185,28,28,0.20)',
      }}
    >
      <div className="flex-1 overflow-y-auto">
        <h2 className="font-bold mb-1.5" style={{ fontSize: 22, color: '#B91C1C' }}>
          Book Free Trial
        </h2>
        <p className="text-base font-medium mb-5 leading-snug" style={{ color: '#CFCFCF' }}>
          at Club72 Gym
        </p>

        {selectedServicesFromPage.length > 0 && (
          <p className="text-sm font-semibold mb-3" style={{ color: '#CFCFCF' }}>
        ...
        <div className="space-y-3">
          <div>
            <label className="block text-[15px] font-semibold mb-1.5" style={{ color: '#B91C1C' }}>Name</label>
            <input
              type="text"
              value={name}
          ...
          <div>
            <label className="block text-[15px] font-semibold mb-1.5" style={{ color: '#B91C1C' }}>Fitness Goal</label>
          ...
          <div className="grid min-w-0 grid-cols-2 gap-2.5">
            <div className="min-w-0">
              <label className="block text-[13px] font-bold mb-1.5" style={{ color: '#B91C1C' }}>Date</label>
              <button
                type="button"
            ...
            <div className="min-w-0">
              <label className="block text-[13px] font-bold mb-1.5" style={{ color: '#B91C1C' }}>Time</label>
          ...
          <button
            ...
            disabled={!isValid}
            className="w-full rounded-xl py-3.5 font-semibold text-[16px] text-white border border-[#E1261C]/60 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer transition-all touch-manipulation active:scale-[0.99] hover:brightness-[1.04]"
            style={{
              background: 'linear-gradient(135deg, #B91C1C 0%, #E1261C 100%)',
              boxShadow: '0 6px 16px rgba(225,38,28, 0.4), inset 0 1px 0 rgba(255,255,255,0.2)',
          ...
          <button
            type="button"
            onClick={onBack}
            className="w-full rounded-xl py-3 font-semibold text-[15px] text-[#B91C1C] border border-[#E1261C]/25 bg-white/35 hover:bg-white/55 backdrop-blur-sm transition-all touch-manipulation active:scale-[0.99] flex items-center justify-center gap-2"
